...
:: Source paths
set "sourceDll=C:\Users\pc\source\repos\OutwardChatCommandsManager\Release\OutwardChatCommandsManager.dll"
...
if exist "%sourceDll%" (
    for %%p in (%profiles%) do (
        set "destinationDll=%baseProfilePath%\%%~p\BepInEx\plugins\gymmed-OutwardChatCommandsManager"
